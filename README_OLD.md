...
- **📱 Unified Dashboard:** `dashboard/` - Central control panel with PRISM branding
- **📈 Campaign Performance (Marketing):** `Campaign performance (marketing)/` - Store performance analysis & marketing intelligence
- **🏦 Loan Delinquency Risk:** `Loan delinquency risk/` - Advanced risk assessment for loan applications  
- **📊 Sell-out Performance Forecasting:** `Sell-out performance forecasting (sales uplift)/` - Sales uplift prediction with AI

All applications feature consistent **Worklet 8** branding with modern, professional UI design.Worklet 8 — Unified Flask Dashboard (Full Documentation)
...
Sell-out Performance Forecasting:
```zsh
...
### A. Campaign Performance (Marketing) — `Campaign performance (marketing)/`

Purpose: Analyze store performance using real sales data to identify top performers, underperformers, and provide specific performance metrics with YES/NO answers and dollar amounts.
...
### B. Loan Delinquency Risk — `Loan delinquency risk/`

Purpose: Advanced risk assessment for loan applications using comprehensive borrower and loan information analysis.
